...
#
# R is the absolute entry-to-stop distance scaled by fill qty:
# for a long-only entry with stop_price below entry_price, R equals
# (entry minus stop) times qty; for a short entry with stop_price
# above entry_price, R equals (stop minus entry) times qty.
#
